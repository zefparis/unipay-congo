...
export default function ExpenseFilters(props: Props) {
  ...
  return (
    <div className="bg-white dark:bg-navy-panel rounded-xl border border-gray-200 dark:border-text-secondary/20 p-4 space-y-3">
      {/* Search */}
      <div className="flex items-center gap-2">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-2 text-xs rounded-lg border border-gray-200 dark:border-text-secondary/20 text-gray-500 hover:bg-gray-50 dark:hover:bg-navy-panel transition-colors"
          >
      ...
      <div className="flex flex-wrap items-center gap-4">
        <label className="flex items-center gap-2 text-sm text-gray-600 dark:text-text-secondary cursor-pointer">
          <input
            type="checkbox"
            checked={props.archived}
            onChange={(e) => props.onArchivedChange(e.target.checked)}
            className="rounded border-gray-300 dark:border-text-secondary/20 text-purple-600 focus:ring-purple-300"
          />
          Archives
        </label>
        <label className="flex items-center gap-2 text-sm text-gray-600 dark:text-text-secondary cursor-pointer">
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <select
            ...
            className="px-2 py-1 rounded-lg border border-gray-200 dark:border-text-secondary/20 bg-white dark:bg-navy-panel text-xs text-gray-900 dark:text-text-primary"
          >
