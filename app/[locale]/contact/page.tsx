    ...
    <>
      <main className="min-h-screen bg-white dark:bg-ink pt-16">
        ...
        <section className="relative overflow-hidden py-20 lg:py-28">
          ...
          {/* Decorative blobs */}
          <div className="absolute top-0 right-[-5%] w-96 h-96 bg-signal/8 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-[-5%] w-64 h-64 bg-signal/6 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-signal/10 border border-signal/25 text-signal text-sm font-medium mb-6">
              <ShieldCheck size={15} />
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="h-full rounded-2xl border border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-ink/60 p-5 sm:p-8">
                ...
                <ul className="space-y-7">
                  {infoItems.map(({ icon: Icon, label, value, href }) => (
                    <li key={label} className="flex items-start gap-4">
                      <div className="w-10 h-10 rounded-xl bg-signal/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-sm text-gray-800 dark:text-gray-200 hover:text-signal dark:hover:text-signal transition-colors leading-relaxed"
                        >
                          {value}
                        </a>
                      </div>
            ...
            <div className="lg:col-span-3">
              <div className="rounded-2xl border border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-ink/60 p-5 sm:p-8">
                <h2 className="text-xl font-heading font-semibold text-gray-900 dark:text-white mb-8">
                  {t('form_title')}
                </h2>
                <ContactForm />
